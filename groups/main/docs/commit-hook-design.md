...
在 Pi agent 回复用户之前，自动检查是否有未 commit 的改动。如果有，block 回复并提醒先 commit。
...
在 `/workspace/project/.pi/settings.local.json` 添加：
...
3. 如果 block 了，Pi agent 会收到什么提示？

## 参考

- Pi Hooks 文档: https://code.claude.com/docs/en/hooks-guide
